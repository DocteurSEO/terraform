...
- **Coût :** le type d'instance « prod » n'est **pas free tier** → reste en dev/petit type pour tester, et `terraform destroy` **par workspace**.
