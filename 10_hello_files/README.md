...
> `app.py` est un **serveur web Flask persistant** (il ne se termine pas) : réfléchis à comment le **démarrer en arrière-plan** pour qu'il survive à la fin de l'`apply` (et ne bloque pas le provisionneur).
